...
@Getter
@Builder
public class ProcessorKeyHh {
  private String actionInstruction;
  private String surveyName;
  private String addressType;
  private String addressLevel;

  public static ProcessorKeyHh buildKey(FwmtCancelActionInstruction rmRequest) {
    return ProcessorKeyHh.builder()
  ...
  public static ProcessorKeyHh buildKey(FwmtActionInstruction rmRequest) {
    return ProcessorKeyHh.builder()
        .actionInstruction(rmRequest.getActionInstruction().toString())
        .surveyName(rmRequest.getSurveyName())
        .addressType(rmRequest.getAddressType())
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ProcessorKeyHh other = (ProcessorKeyHh) obj;
